    ...
    <main>
        <div class="display-area">
            ...
            <nav class="nav">
                ...
                <p>Rustic Marble Car</p>
            </nav>

            <!-- Product details -->
            <div class="product-details">
                <div class="product-details__left">
                    <img src="../assets/images/product-17.jpg" alt="Rustic Marble Car"
                        class="product-details__img">
                </div>
                <div class="product-details__right">
                    <span class="product-details__status">In Stock</span>
                    <h1 class="product-details__title">Rustic Marble Car</h1>
                    <div class="product-details__sku">SKU: RUSTIC-MARBLE-CAR-71977874</div>
                    <div class="product-details__price">$899.41</div>
                    ...
                    <p class="product-details__desc">Labore architecto perspiciatis voluptatem suscipit. Ea ex aut modi cumque et ipsa.</p>
                    ...
                    <div class="product-details__categories">
                        ...
                        <a href="../product-category/clothings.php"> Clothings</a>
                    </div>
        ...
        <div class="label">
            ...
            <div class="label__content">
                <div class="desc__content">
                    <p>Aut saepe voluptas cumque placeat. Vel quaerat corporis provident. Quo expedita est sint quos veritatis saepe.</p>
                    <p>Est voluptas ut voluptatem doloremque ullam suscipit sunt. Sit ipsa officiis perferendis nam voluptatem quaerat voluptatibus dignissimos. Et vel perspiciatis qui est perferendis. Ut perspiciatis aliquam pariatur quia. Et quia rerum voluptatem saepe.</p>
                    <p>Quia autem perferendis voluptate maxime omnis officia. Qui rem molestias quis voluptatum necessitatibus accusamus delectus. Laborum beatae blanditiis voluptatem illum saepe. Dolorem id odit id pariatur porro repellat.</p>
                    <p>Quas ducimus doloribus voluptatem corporis tempora est quod nulla. Consequatur dolorum laudantium inventore sint aspernatur placeat tempora.</p>
                    <p>Facilis dicta delectus autem. Doloremque consequatur ut autem maiores molestias. Perspiciatis nihil rerum ea id repudiandae rerum. Et velit eligendi magni molestiae mollitia aliquam.</p>
                </div>
