                    ...
                    <ul class="navbar__list">
                        ...
                        <li class="navbar__dropdown">
                            ...
                            <ul class="navbar__dropdown-content">
                                <li><a href="./product-management.php" class="navbar__link dropdown__item">Product</a>
                                </li>
                    ...
                    <a href="#!" id="account" class="action__account">
                        ...
                        <form id="login__form" class="action__login-form" action="./src/controller/login-handle.php"
                            ...
                            <div class="login-form__head">
                                ...
                                <a href="account.php" target="_blank" class="login-form__create-account">
                                    Create an Account
                                </a>
                            </div>
                            <div class="login-form__container">
                                ...
                                <input type="text" placeholder="Username" name="uname" id="login-form__uname"
                                    required />
                                <label for="psw">
                                ...
                                <input type="password" placeholder="Password" name="psw" id="login-form__psw"
                                    required />
                                <button type="submit" class="login-form__btn" name="submit">
                                    LOGIN
                                </button>
                            </div>
            ...
            <div class="display-area">
                <div class="features__content">
                    <div class="features__item">
                        <img src="./assets/icons/pet-easy.svg" alt="" class="features__icon" />
                        <p class="features__desc">
                            Making Pet Parenting Easy
                        </p>
                    </div>
                    <div class="features__item">
                        <img src="./assets/icons/free-delivery.svg" alt="" class="features__icon" />
                        <p class="features__desc">
                            Wide Range, Free Delivery
                        </p>
                    </div>
                    <div class="features__item">
                        <img src="./assets/icons/rewards.svg" alt="" class="features__icon" />
                        <p class="features__desc">Save More With Rewards</p>
                    </div>
                    <div class="features__item">
                        <img src="./assets/icons/best-choose.svg" alt="" class="features__icon" />
                        <p class="features__desc">
                            Helping You Choose the Best
                        </p>
                    </div>
                    <div class="features__item">
                        <img src="./assets/icons/delivered.svg" alt="" class="features__icon" />
                        <p class="features__desc">Delivered To Your Door</p>
                    </div>
                    <div class="features__item">
                        <img src="./assets/icons/protection-card-payment.svg" alt="" class="features__icon" />
                        <p class="features__desc">
            ...
            <div class="categories__content">
                <div class="categories__row">
                    <h2 class="categories__heading">
                        ...
                        <img src="./assets/icons/pet-foot.png" alt="" class="categories__icon" />
                    </h2>
                ...
                <div class="categories__list">
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-1.jpg" alt="Food" class="categories__img" />
                        <p class="categories__title">Food</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-2.jpg" alt="Pharmacy" class="categories__img" />
                        <p class="categories__title">Pharmacy</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-3.jpg" alt="Furniture" class="categories__img" />
                        <p class="categories__title">Furniture</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-4.jpg" alt="Toys" class="categories__img" />
                        <p class="categories__title">Toys</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-5.jpg" alt="Beds" class="categories__img" />
                        <p class="categories__title">Beds</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-6.jpg" alt="Bowls" class="categories__img" />
                        <p class="categories__title">Bowls</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-7.jpg" alt="Treats" class="categories__img" />
                        <p class="categories__title">Treats</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-8.jpg" alt="Crates" class="categories__img" />
                        <p class="categories__title">Crates</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-9.jpg" alt="Flea & Tick" class="categories__img" />
                        <p class="categories__title">Flea & Tick</p>
                    </a>
                    <a href="#!" class="categories__item">
                        <img src="./assets/images/categories-10.jpg" alt="Clothings" class="categories__img" />
            ...
            <div class="display-area">
                <div class="offers__content">
                    <h2 class="offers__heading">
                        Offers On Pet
                        <img src="./assets/icons/pet-foot.png" alt="" class="offers__icon" />
                    </h2>
                ...
                <div class="trending__content">
                    <div class="trending__row">
                        <h2 class="trending__heading">
                            Trending This Week
                            <img src="./assets/icons/pet-foot.png" alt="" class="trending__icon" />
                        </h2>
                        <div class="trending__action">
                            <button onclick="filterProducts('all', this)" class="trending__btn trending--active">
                                All Items
                            </button>
                            <button onclick="filterProducts('sales', this)" class="trending__btn">
                                Sales
                            </button>
                            <button onclick="filterProducts('featured', this)" class="trending__btn">
                                Featured
                            </button>
                            <button onclick="filterProducts('bestseller', this)" class="trending__btn">
                                Best Seller
                            </button>
                        </div>
                    </div>
                    <div class="trending__list">
                        <!-- Product 1 -->
                        <a href="#!" data-category="all sales featured" class="trending__product product">
                        ...
                        <!-- Product 2 -->
                        <a href="#!" data-category="all bestseller" class="trending__product product">
                            <div class="product__thumb">
                                <img src="./assets/images/product-2.jpg" alt="Gorgeous Bronze Knife"
                                    class="product__img" />
                                <button class="product__wishlist">
                                    <svg width="20px" height="20px" viewBox="0 0 64 64"
                                        xmlns="http://www.w3.org/2000/svg" stroke-width="5" stroke="currentColor"
                        ...
                        <!-- Product 4 -->
                        <a href="#!" data-category="all" class="trending__product product">
                            <div class="product__thumb">
                                <img src="./assets/images/product-4.jpg" alt="Rustic Iron Hat" class="product__img" />
                                <button class="product__wishlist">
                                    <svg width="20px" height="20px" viewBox="0 0 64 64"
                                        xmlns="http://www.w3.org/2000/svg" stroke-width="5" stroke="currentColor"
                                        fill="none">
                        ...
                        <!-- Product 6 -->
                        <a href="#!" data-category="all sales featured bestseller" class="trending__product product">
                            <div class="product__thumb">
                        ...
                        <!-- Product 8 -->
                        <a href="#!" data-category="all sales bestseller" class="trending__product product">
                            <div class="product__thumb">
                        ...
                        <!-- Product 9 -->
                        <a href="#!" data-category="all sales" class="trending__product product">
                            <div class="product__thumb">
                                <img src="./assets/images/product-9.jpg" alt="Awesome Leather Shoes"
                                    class="product__img" />
                                <button class="product__wishlist">
                                    <svg width="20px" height="20px" viewBox="0 0 64 64"
                                        xmlns="http://www.w3.org/2000/svg" stroke-width="5" stroke="currentColor"
                        ...
                        <!-- Product 13 -->
                        <a href="#!" data-category="featured bestseller" class="trending__product product">
                            <div class="product__thumb">
                        ...
                        <!-- Product 14 -->
                        <a href="#!" data-category="featured" class="trending__product product">
                            <div class="product__thumb">
                                <img src="./assets/images/product-14.jpg" alt="Small Bronze Chair"
                                    class="product__img" />
                                <button class="product__wishlist">
                                    <svg width="20px" height="20px" viewBox="0 0 64 64"
                                        xmlns="http://www.w3.org/2000/svg" stroke-width="5" stroke="currentColor"
                        ...
                        <!-- Product 18 -->
                        <a href="#!" data-category="sales featured" class="trending__product product">
                            <div class="product__thumb">
            ...
            <div class="display-area">
                <div class="cta__content">
                    <div class="cta__left">
                        ...
                        <a href="#!" class="cta__btn btn">Shop Now
                            <div class="chevron">
                                <svg width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 6L15 12L9 18" stroke="currentColor" stroke-width="2"
                    ...
                    <a href="#!" class="cta__right">
                        ...
                        <img src="./assets/images/cta-2-sub.png" alt="" class="cta__hotline-sub" />
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="pr">
            <div class="display-area">
                <div class="pr__content">
                    ...
                    <a href="#!" class="pr__btn btn">Shop Now
                        <div class="chevron">
                            <svg width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 6L15 12L9 18" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <img src="./assets/images/pr-sub.png" alt="" class="pr__img-sub" />
            </div>
        </div>
        ...
        <div class="selling">
            <div class="display-area">
                <div class="selling__content">
                    <div class="selling__row">
                        <h2 class="selling__heading">
                            ...
                            <img src="./assets/icons/pet-foot.png" alt="" class="selling__icon" />
                        </h2>
                ...
                <div class="selling__list list-dog">
                    ...
                    <a href="#!" class="selling__product product">
                        <div class="product__thumb">
                            <img src="./assets/images/product-1.jpg" alt="Ergonomic Paper Clock" class="product__img" />
                            <button class="product__wishlist">
                                <svg width="20px" height="20px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
                                    stroke-width="5" stroke="currentColor" fill="none">
                                    <path
                ...
                <div class="selling__list list-cat">
                    ...
                    <a href="#!" class="selling__product product">
                        <div class="product__thumb">
                            <img src="./assets/images/product-2.jpg" alt="Gorgeous Bronze Knife" class="product__img" />
                            <button class="product__wishlist">
                                <svg width="20px" height="20px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
                                    stroke-width="5" stroke="currentColor" fill="none">
                                    <path
                    ...
                    <a href="#!" class="selling__product product">
                        <div class="product__thumb">
                            <img src="./assets/images/product-9.jpg" alt="Awesome Leather Shoes" class="product__img" />
                            <button class="product__wishlist">
                                <svg width="20px" height="20px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
                                    stroke-width="5" stroke="currentColor" fill="none">
                                    <path
                    ...
                    <a href="#!" class="selling__product product">
                        <div class="product__thumb">
                            <img src="./assets/images/product-18.jpg" alt="Gorgeous Paper Clock" class="product__img" />
                            <button class="product__wishlist">
                                <svg width="20px" height="20px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
                                    stroke-width="5" stroke="currentColor" fill="none">
                                    <path
                ...
                <div class="brands__content">
                    <div class="brands__row">
                        <h2 class="brands__heading">
                            Shop By Brands
                            <img src="./assets/icons/pet-foot.png" alt="" class="brands__icon" />
                        </h2>
                    ...
                    <div class="brands__list">
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-1.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-2.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-3.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-4.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-5.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-6.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-7.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-8.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-9.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-10.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-11.svg" alt="" class="brands__img" />
                        </a>
                        <a href="#!" class="brands__item">
                            <img src="./assets/icons/brand-12.svg" alt="" class="brands__img" />
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="viewed__content">
                    <div class="viewed__row">
                        <h2 class="viewed__heading">
                            ...
                            <img src="./assets/icons/pet-foot.png" alt="" class="viewed__icon" />
                        </h2>
                    ...
                    <div class="viewed__list">
                        ...
                        <div class="viewed__item">
                            ...
                            <div class="viewed__caption">
                                ...
                                <strong class="viewed__price">$305.49</strong>
                            </div>
                        </div>
                        <!-- Item 2 -->
                        <div class="viewed__item">
                            ...
                            <div class="viewed__caption">
                                ...
                                <strong class="viewed__price">$66.17</strong>
                            </div>
                        </div>
                        <!-- Item 3 -->
                        <div class="viewed__item">
                            <img src="./assets/images/product-7.jpg" alt="Rustic Marble Car" class="viewed__img" />
                            <div class="viewed__caption">
                                <a href="#!" class="viewed__title">
                                    Rustic Marble Car
                                </a>
                        ...
                        <!-- Item 4 -->
                        <div class="viewed__item">
                            <img src="./assets/images/product-14.jpg" alt="Small Bronze Chair" class="viewed__img" />
                            <div class="viewed__caption">
                                <a href="#!" class="viewed__title">
                                    Small Bronze Chair
                                </a>
                                <strong class="viewed__price">$262.45</strong>
                            </div>
                        </div>
                        <!-- Item 5 -->
                        <div class="viewed__item">
                        ...
                        <div class="viewed__item">
                            ...
                            <div class="viewed__caption">
                                ...
                                <strong class="viewed__price">$426.03</strong>
                            </div>
                        </div>
                        <!-- Item 7 -->
                        <div class="viewed__item">
                            <img src="./assets/images/product-1.jpg" alt="Ergonomic Paper Clock" class="viewed__img" />
                            <div class="viewed__caption">
                                <a href="#!" class="viewed__title">
                                    Ergonomic Paper Clock
                                </a>
                                <strong class="viewed__price">$853.93</strong>
                            </div>
                        </div>
                        <!-- Item 8 -->
                        <div class="viewed__item">
                            ...
                            <div class="viewed__caption">
                                ...
                                <strong class="viewed__price">$786.43</strong>
                            </div>
                        </div>
                        <!-- Item 9 -->
                        <div class="viewed__item">
                            <img src="./assets/images/product-17.jpg" alt="Practical Linen Knife" class="viewed__img" />
                            <div class="viewed__caption">
                                <a href="#!" class="viewed__title">
                                    Practical Linen Knife
                                </a>
                                <strong class="viewed__price">$857.64</strong>
                            </div>
                        </div>
                        <!-- Item 10 -->
                        <div class="viewed__item">
                            <img src="./assets/images/product-6.jpg" alt="Mediocre Marble Bench" class="viewed__img" />
                            <div class="viewed__caption">
                                <a href="#!" class="viewed__title">
                                    Mediocre Marble Bench
                                </a>
                                <strong class="viewed__price">$983.99</strong>
                            </div>
                        </div>
                    </div>
                </div>
